...
이 프로젝트는 [NomaDamas/k-skill](https://github.com/NomaDamas/k-skill)에서 모은 86개의 K-스킬을 **문명 5(Civilization V)의 세종대왕 알현 장면** 컨셉으로 탐색할 수 있는 인터랙티브 랜딩 페이지입니다. 방문자는 한옥 문을 열고 궁궐 안으로 들어서서 세종대왕을 알현하고, 하오체로 대화하며 원하는 스킬을 찾아갑니다.
...
- **8개 카테고리, 86개 K-스킬**: 교통/예약, 음식/생활, 쇼핑/가격, 정부/공공, 스포츠/엔터, 문서/검색, 부동산/금융, 기타 — 8개 카테고리에 걸쳐 86개 스킬을 탐색할 수 있습니다.
